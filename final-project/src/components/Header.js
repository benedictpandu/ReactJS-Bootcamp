...
const Header = () => {
  return (
    <header className="w-full h-16 mb-5 z-40 flex items-center justify-between">
                ...
                <div className="relative p-1 flex items-center w-full space-x-4 justify-end">
                    ...
                    <img alt="profil" src="https://cdn.icon-icons.com/icons2/1904/PNG/512/profile_121261.png" className="mx-auto h-8 w-8 " />
                    </a>
