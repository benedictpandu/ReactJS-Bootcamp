...
const BigCard = () => {
  return (
    <>
    <div className="bg-white shadow-xl m-10 lg:m-24 overflow-hidden sm:rounded-lg">
      <div className="px-4 py-5 sm:px-6">
        <img src='https://assets.tokopedia.net/assets-tokopedia-lite/v2/arael/kratos/36c1015e.png' className='w-28 md:w-32'/>
