  ...
  return (
    <footer className="bg-white mt-24" aria-labelledby="footer-heading">
        ...
        <div className="px-5 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:flex-gap">
                <div className="flex md:w-1/3 justify-evenly md:justify-between ">
                <div>
                    <h3 className="text-xs font-semibold tracking-wider text-yellow-300 uppercase">Solutions</h3>
                ...
                <div className="">
                    <h3 className="text-xs font-semibold tracking-wider text-yellow-300 uppercase">Support</h3>
                    <ul role="list" className="mt-4 space-y-4">
                    <li>
                ...
                <div className="w-full mt-12 md:mt-0">
                    <div className="mt-8 text-center lg:text-left justify-center lg:ml-20 lg:justify-end xl:mt-0">
                    ...
                    <div className="inline-flex items-center gap-2 list-none lg:ml-auto">
                        ...
                        <div className="mt-4 sm:mt-0 sm:ml-3 revue-form-actions">
                            <button type="submit" value="Subscribe" name="member[subscribe]" id="member_submit" className="block w-full px-5 py-3 text-base font-medium text-white bg-yellow-300 border border-transparent rounded-lg shadow hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10">Notify me</button>
                        </div>
                        </form>
                    </div>
                    </div>
        ...
        <div className="px-5 py-12 mx-auto bg-gray-50 w-full sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
